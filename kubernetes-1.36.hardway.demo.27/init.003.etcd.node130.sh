...
scp /root/IMAGES/etcd-v3.6.11-linux-amd64.tar.gz root@192.168.200.${i}:/root
#pdsh -R ssh -w root@192.168.200.${i} "wget -q --show-progress --https-only --timestamping 'https://github.com/etcd-io/etcd/releases/download/v3.6.11/etcd-v3.6.11-linux-amd64.tar.gz'"
pdsh -R ssh -w root@192.168.200.${i} "tar -xvf /root/etcd-v3.6.11-linux-amd64.tar.gz"
pdsh -R ssh -w root@192.168.200.${i} "sudo mv /root/etcd-v3.6.11-linux-amd64/etcd* /usr/local/bin/"
