...
KUBERNETES_HOSTNAMES=kubernetes,kubernetes.default,kubernetes.default.svc,kubernetes.default.svc.cluster.local,node130,node131,node132,node130.cloud.local,node131.cloud.local,node132.cloud.local,10.96.128.1,192.168.200.130,192.168.200.131,192.168.200.132,192.168.200.139
