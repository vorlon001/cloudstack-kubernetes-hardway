...
scp /root/IMAGES/etcd-v3.5.14-linux-amd64.tar.gz root@192.168.200.${i}:/root
...
pdsh -R ssh -w root@192.168.200.${i} "tar -xvf /root/etcd-v3.5.14-linux-amd64.tar.gz"
pdsh -R ssh -w root@192.168.200.${i} "sudo mv /root/etcd-v3.5.14-linux-amd64/etcd* /usr/local/bin/"
